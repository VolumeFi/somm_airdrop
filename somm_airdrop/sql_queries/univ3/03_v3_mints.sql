...
SELECT DISTINCT
    logs.block_timestamp AS block_timestamp
     ...
     ,PARSE_TRANSFER(transfer_logs.data, transfer_logs.topics).dst as pool
...
FROM `bigquery-public-data.crypto_ethereum.logs` AS logs
    ...
    AND transfer_logs.topics[SAFE_OFFSET(1)] = '0x000000000000000000000000c36442b4a4522e871399cd717abdd847ab11fe88'
);
